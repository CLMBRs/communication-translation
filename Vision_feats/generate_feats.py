...
BeitFeat = BeitFeatureExtractor.from_pretrained("microsoft/beit-large-patch16-224") 
transforms_dict = {
    ...
    #     transforms.ToTensor(),
    #     ]),
      'beit': lambda x: torch.from_numpy(BeitFeat(x)['pixel_values'][0]) 
}
...
def downsample(feats, args):
    ...
    m = nn.AvgPool2d(args.kernel_size, stride=args.kernel_size)
