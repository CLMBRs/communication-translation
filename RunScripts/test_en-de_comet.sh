...
en2de="$(comet-score -s ${reference_dir}/de-en.en.test -t ${TRANSLATION_OUTPUT_DIR}/de-en.en.test.de -r ${reference_dir}/de-en.de.test)"
...
de2en="$(comet-score -s ${reference_dir}/de-en.de.test -t ${TRANSLATION_OUTPUT_DIR}/de-en.de.test.en -r ${reference_dir}/de-en.en.test)"
