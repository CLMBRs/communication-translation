...
python -u BackTranslation/translate.py --config Configs/t2i/test_en2de_translate.yml
...
python -u BackTranslation/translate.py --config Configs/t2i/test_de2en_translate.yml
