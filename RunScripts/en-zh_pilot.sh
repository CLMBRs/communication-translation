...
en2zh=$(./Tools/bleu.sh Output/en-zh_pilot/zh-en.en.val.zh Output/en-zh_pilot/zh-en.zh.val zh)
zh2en=$(./Tools/bleu.sh Output/en-zh_pilot/zh-en.zh.val.en Output/en-zh_pilot/zh-en.en.val 13a)
