...
en2zh="$(comet-score -s ${reference_dir}/zh-en.en.test -t ${TRANSLATION_OUTPUT_DIR}/zh-en.en.test.zh -r ${reference_dir}/zh-en.zh.test)"
...
zh2en="$(comet-score -s ${reference_dir}/zh-en.zh.test -t ${TRANSLATION_OUTPUT_DIR}/zh-en.zh.test.en -r ${reference_dir}/zh-en.en.test)"
