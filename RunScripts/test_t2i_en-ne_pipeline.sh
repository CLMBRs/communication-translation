...
python -u BackTranslation/translate.py --config Configs/t2i/test_en2ne_translate.yml
...
python -u BackTranslation/translate.py --config Configs/t2i/test_ne2en_translate.yml
