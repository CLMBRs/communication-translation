...
python -u BackTranslation/translate.py --config Configs/t2i/test_en2zh_translate.yaml
...
python -u BackTranslation/translate.py --config Configs/t2i/test_zh2en_translate.yaml
