...
python -u BackTranslation/translate.py --config Configs/t2i/test_en2si_translate.yml
...
python -u BackTranslation/translate.py --config Configs/t2i/test_si2en_translate.yml
