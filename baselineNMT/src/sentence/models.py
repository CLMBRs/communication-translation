    ...
    def __init__(self, lang, args):
        ...
        if args.w2v:
            self.emb = nn.Embedding.from_pretrained(
                args.en_embed, freeze=True, padding_idx=0
            )
        else:
            self.emb = nn.Embedding(
                args.vocab_size[lang], args.D_emb, padding_idx=0
            )
...
class Speaker(torch.nn.Module):
    def __init__(self, lang, args):
        ...
        if args.w2v:
            self.emb = nn.Embedding.from_pretrained(
                args.l2_embed, freeze=True, padding_idx=0
            )
        else:
            self.emb = nn.Embedding(
                args.vocab_size[lang], args.D_emb, padding_idx=0
