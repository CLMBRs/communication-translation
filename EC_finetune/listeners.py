...
class Listener(Module):
    """
    Abstract class for the "listener" component of a Pytorch communication agent
    
    Listeners implemented from various models can be passed to the
    ...
    def forward(
        ...
        Listener must meet the Args and Returns interface constraints
...
class BartListener(Listener):
    """
    A Bart Listener subclass that can be input to a CommunicationAgent for
    communication games
...
MBartListener = BartListener


class RnnListener(Listener):
    """
    An RNN Listener subclass that can be input to a CommunicationAgent for
    communication games
